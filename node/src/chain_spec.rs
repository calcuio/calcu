...
/// Calcu rocky(aka. internal testnet) config
pub fn rocky_config() -> Result<CalcuChainSpec, String> {
    CalcuChainSpec::from_json_bytes(&include_bytes!("../res/rocky.json")[..])
}

/// Calcu maxwell(aka. open testnet) config
pub fn maxwell_config() -> Result<CalcuChainSpec, String> {
    CalcuChainSpec::from_json_bytes(&include_bytes!("../res/maxwell.json")[..])
}

/// Calcu rocky staging config
pub fn rocky_staging_config() -> Result<CalcuChainSpec, String> {
...
/// Calcu maxwell staging config
pub fn maxwell_staging_config() -> Result<CalcuChainSpec, String> {
...
/// The genesis spec of calcu rocky test network
...
/// The genesis spec of calcu maxwell test network
